...
const navByEnv: Record<Environment, NavGroup[]> = {
  ...
  experience: [
    {
      ...
      items: [
        ...
        { label: "Launch check", href: "/admin/go-live", icon: "checklist" },
    ...
    },
    {
      ...
      items: [
        ...
        { label: "wind.coach guides", href: "/admin/windcoach-guides", icon: "file" },
    ...
    },
    {
      label: "MARKETING",
      items: [
        { label: "Promo Studio", href: "/admin/promo", icon: "image" },
  ...
  hardware: [
    ...
    },
    {
      label: "SELLING",
      items: [
        { label: "Pre-orders", href: "/admin/preorders", icon: "calendar" },
