  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: `url('${STORAGE}/photos/hero-bg.jpg')` }}
      />
          ...
          <div className="rounded-2xl p-7 transition-all duration-300 border border-white/10 hover:border-white/20 flex flex-col" style={boxStyle}>
            ...
            <div className="space-y-2.5 flex-1">
              {experiences.map((exp) => {
                ...
                return (
                  <a key={exp.title} href={exp.url} target="_blank" rel="noopener noreferrer"
                    className="block rounded-xl p-3.5 transition-all duration-200 group border border-white/[0.08] hover:border-white/[0.15]"
                    style={{ background: itemBg }}>
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0">
