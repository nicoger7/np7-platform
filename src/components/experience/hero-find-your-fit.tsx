...
const SEGMENTS: Segment[] = [
  ...
  { id: "returnee", chip: "I'm getting back into it", icon: I.cycle, tag: "The comeback", title: "Back on the water after a break.", body: "It's been a few years and you're not sure what you've still got. Don't worry — it comes back fast, and we make the whole thing easy.", points: ["Patient coaching that meets you where you are", "Small groups, zero pressure", "All gear sorted — just turn up and sail", "You'll be planing again by day two"], cta: "Find your week", image: "https://media.np-seven.com/experiences/np7-lake-garda-2026/action/participant-entering-the-water.jpg" },
