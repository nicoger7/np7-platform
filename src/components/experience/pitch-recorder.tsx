    ...
    <div className="rounded-2xl border-2 border-dashed border-[#ecdcbb] bg-[#fffdf8] p-4 sm:p-5">
      {mode === "choose" && (
        <div>
          ...
          <p className="text-[12px] text-[#9aa6ac] mt-2.5">Up to 2 minutes. Tell us who you are and why this trip. No need to be polished. {supported ? "" : "(Recording isn’t supported on this browser, so upload a file instead.)"}</p>
