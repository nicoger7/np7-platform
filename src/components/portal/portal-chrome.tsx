...
export async function PortalChrome({ section }: { section?: "experience" | "hardware" } = {}) {
  ...
  return (
    <>
      ...
      {siteLive ? (
        resolved === "hardware" ? <HardwareHeader variant="docked" /> : <OceanHeader variant="docked" showExperience={showExp} showAbout={flags.showAbout} showHardware={flags.showHardware} showBlog={flags.showBlog} />
      ) : (
